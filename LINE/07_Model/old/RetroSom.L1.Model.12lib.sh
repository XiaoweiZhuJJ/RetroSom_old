...
awk '$5="lib1_"$5' OFS='\t' $8/$sub2\1/retro_v41_$6/$TE/$sub2\1.sr.pred.posreads > $2/$sub/$Retro/sr1.txt
awk '$5="lib2_"$5' OFS='\t' $8/$sub2\2/retro_v41_$6/$TE/$sub2\2.sr.pred.posreads > $2/$sub/$Retro/sr2.txt
awk '$5="lib3_"$5' OFS='\t' $8/$sub2\3/retro_v41_$6/$TE/$sub2\3.sr.pred.posreads > $2/$sub/$Retro/sr3.txt
awk '$5="lib4_"$5' OFS='\t' $8/$sub2\4/retro_v41_$6/$TE/$sub2\4.sr.pred.posreads > $2/$sub/$Retro/sr4.txt
awk '$5="lib5_"$5' OFS='\t' $8/$sub2\5/retro_v41_$6/$TE/$sub2\5.sr.pred.posreads > $2/$sub/$Retro/sr5.txt
awk '$5="lib6_"$5' OFS='\t' $8/$sub2\6/retro_v41_$6/$TE/$sub2\6.sr.pred.posreads > $2/$sub/$Retro/sr6.txt
