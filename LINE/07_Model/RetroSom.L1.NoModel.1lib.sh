...
awk '$5="lib1_"$5' OFS='\t' $2/$sub2\15/$Retro/$sub2\15.sr.tabe.discover > $2/$sub/$Retro/sr1.txt
cat $2/$sub/$Retro/sr1.txt \
    > $2/$sub/$Retro/$sub.$TE.sr.tabe.discover
rm $2/$sub/$Retro/sr1.txt

### combine the PE reads ###
awk '$5="lib1_"$5' OFS='\t' $2/$sub2\15/$Retro/$TE/$sub2\15.$TE.nodup.sites > $2/$sub/$Retro/pe1.txt
