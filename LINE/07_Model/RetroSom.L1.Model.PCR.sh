...
awk '$5="lib1_"$5' OFS='\t' $2/$sub2$lib/$Retro/$sub2$lib.alignfilter.discover | grep L1 >  $2/$sub/$Retro/$sub.LINE.alignfilter.discover
...
$masterpath/utls/17_parse_overlap.pl $3 LINE $2 $1$8$7
