...
awk '$5="lib1_"$5' OFS='\t' $2/$sub2\15/$Retro/$TE/$sub2\15.sr.pred.posreads > $2/$sub/$Retro/sr1.txt
...
awk '$5="lib1_"$5' OFS='\t' $2/$sub2\15/$Retro/$TE/$sub2\15.pe.pred.posreads > $2/$sub/$Retro/pe1.txt
...
awk '$5="lib1_"$5' OFS='\t' $2/$sub2\15/$Retro/$sub2\15.alignfilter.discover | grep L1 >  $2/$sub/$Retro/$sub.LINE.alignfilter.discover
