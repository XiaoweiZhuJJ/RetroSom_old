...
my $m1_file  = $workfolder.'/'.$sample.'/'.$retro.'_0/'.$sample.'.sr.LINE.matrix2';
my $m2_file  = $workfolder.'/'.$sample.'/'.$retro.'_1/'.$sample.'.sr.LINE.matrix2';
    ...
    if ($data[4] == 1)
       {
        ...
        if ($data[8] eq 'NA')
           ...
           {
            $basep_0 ++ if ($data[8] <= 0.5);
            $basep_1 ++ if ($data[8] >  0.5);
           }
        $pos_total++;
       }
    elsif ($data[4] == 0)
       {
        ...
        if ($data[8] eq 'NA')
           ...
           {
            $basen_0 ++ if ($data[8] <= 0.5);
            $basen_1 ++ if ($data[8] >  0.5);
           }
        $neg_total++;
       }
    print OU2 "$line\t$pred\n";
