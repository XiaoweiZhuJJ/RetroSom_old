...
$masterpath/ALU/07_Model/RetroSom.ALU.Model.6lib.edit.sh $4 $workfolder $Retro $hg 1 $2 $masterpath $9
$masterpath/ALU/07_Model/RetroSom.ALU.Model.6lib.edit.sh $5 $workfolder $Retro $hg 1 $2 $masterpath $9
$masterpath/ALU/07_Model/RetroSom.ALU.Model.6lib.edit.sh $6 $workfolder $Retro $hg 1 $2 $masterpath $9
$masterpath/ALU/07_Model/RetroSom.ALU.NoModel.6lib.sh $4 $workfolder $Retro $hg 1 $2 $masterpath $9
$masterpath/ALU/07_Model/RetroSom.ALU.NoModel.6lib.sh $5 $workfolder $Retro $hg 1 $2 $masterpath $9
$masterpath/ALU/07_Model/RetroSom.ALU.NoModel.6lib.sh $6 $workfolder $Retro $hg 1 $2 $masterpath $9
...
$masterpath/utls/17_parse_overlap.pl $1\_$2 ALU $workfolder $6

$masterpath/ALU/05_somatic/05_submit_somatic_6lib.sh $6 $4 $1 $2 $3 $masterpath $9
$masterpath/ALU/05_somatic/05_submit_somatic_6lib.sh $6 $5 $1 $2 $3 $masterpath $9
$masterpath/ALU/05_somatic/05_submit_somatic_6lib.sh $4 $6 $1 $2 $3 $masterpath $9
$masterpath/ALU/05_somatic/05_submit_somatic_6lib.sh $5 $6 $1 $2 $3 $masterpath $9
