...
awk '$5="lib1_"$5' OFS='\t' $2/$sub2\7/$Retro/$sub2\7.alignfilter.discover | grep Alu >  $2/$sub/$Retro/$sub.ALU.alignfilter.discover
awk '$5="lib2_"$5' OFS='\t' $2/$sub2\8/$Retro/$sub2\8.alignfilter.discover | grep Alu >> $2/$sub/$Retro/$sub.ALU.alignfilter.discover
