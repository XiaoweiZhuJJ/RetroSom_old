...
my $ou1_file = $workfolder.'/'.$sample.'/'.$retro.'_0/ALU/'.$sample.'.pe2.pred.all.filter'.$FILTER.'.txt';
my $ou2_file = $workfolder.'/'.$sample.'/'.$retro.'_0/ALU/'.$sample.'.pe2.pred.filter'.$FILTER.'.summary';
my $ou3_file = $workfolder.'/'.$sample.'/'.$retro.'_1/ALU/'.$sample.'.pe2.pred.all.filter'.$FILTER.'.txt';
my $ou4_file = $workfolder.'/'.$sample.'/'.$retro.'_1/ALU/'.$sample.'.pe2.pred.filter'.$FILTER.'.summary';
my @order = (1,2); 
