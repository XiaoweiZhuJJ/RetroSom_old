...
sub _findCandidates
{
    ...
    if( $doAlign )
    {
        ...
        system("exonerate --model affine:local --bestn 5 --ryo \"INFO: %qi %qal %pi %tS %ti %qab %qae %tab %tae %qs\\n\" $candidatesFasta $refsFasta --querychunkid 1 --querychunktotal 4 > $exo_file");
        system("exonerate --model affine:local --bestn 5 --ryo \"INFO: %qi %qal %pi %tS %ti %qab %qae %tab %tae %qs\\n\" $candidatesFasta $refsFasta --querychunkid 2 --querychunktotal 4 >> $exo_file");
        system("exonerate --model affine:local --bestn 5 --ryo \"INFO: %qi %qal %pi %tS %ti %qab %qae %tab %tae %qs\\n\" $candidatesFasta $refsFasta --querychunkid 3 --querychunktotal 4 >> $exo_file");
        system("exonerate --model affine:local --bestn 5 --ryo \"INFO: %qi %qal %pi %tS %ti %qab %qae %tab %tae %qs\\n\" $candidatesFasta $refsFasta --querychunkid 4 --querychunktotal 4 >> $exo_file");
        ...
        if( $srmode && -s $clipFasta )
           {
            ...
            system("exonerate --model affine:local --bestn 5 --ryo \"INFO: %qi %qal %pi %tS %ti %ql %qab %qae %tab %tae %tas %qas %qs\\n\" $clipFasta $refsFasta --querychunkid 1 --querychunktotal 4 > $exo_file");
            system("exonerate --model affine:local --bestn 5 --ryo \"INFO: %qi %qal %pi %tS %ti %ql %qab %qae %tab %tae %tas %qas %qs\\n\" $clipFasta $refsFasta --querychunkid 2 --querychunktotal 4 >> $exo_file");
            system("exonerate --model affine:local --bestn 5 --ryo \"INFO: %qi %qal %pi %tS %ti %ql %qab %qae %tab %tae %tas %qas %qs\\n\" $clipFasta $refsFasta --querychunkid 3 --querychunktotal 4 >> $exo_file");
            system("exonerate --model affine:local --bestn 5 --ryo \"INFO: %qi %qal %pi %tS %ti %ql %qab %qae %tab %tae %tas %qas %qs\\n\" $clipFasta $refsFasta --querychunkid 4 --querychunktotal 4 >> $exo_file");
